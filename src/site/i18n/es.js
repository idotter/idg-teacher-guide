  ...
  pages: {
    ...
    privacy: {
      ...
      body: [
        ...
        { t: 'p', v: 'No hay registro, no hay cookies de análisis ni de publicidad y no se suben las cartas guardadas ni los ajustes. La aplicación y la página de inicio no almacenan nada tuyo en nuestros servidores. Solo llevamos una estadística de uso anónima, sin referencia a personas, véase más abajo.' },
