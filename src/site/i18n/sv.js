  ...
  pages: {
    ...
    privacy: {
      ...
      body: [
        ...
        { t: 'p', v: 'Det finns ingen registrering, inga analys- eller reklamcookies och ingen uppladdning av sparade kort eller inställningar. Appen och startsidan lagrar ingenting om dig på våra servrar. Det enda vi för är en anonym användningsstatistik utan koppling till personer, se nedan.' },
