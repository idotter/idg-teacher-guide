  ...
  pages: {
    ...
    privacy: {
      ...
      body: [
        ...
        { t: 'p', v: 'There is no registration, there are no analytics or advertising cookies, and saved cards and settings are not uploaded. The app and the landing page store nothing on our servers.' },
        ...
        { t: 'p', v: 'The website is delivered through a web host. The host may process technical logs (such as time, address requested, shortened IP address, browser identification) as far as this is necessary for operation, security and troubleshooting. The information provided by the respective host applies to this.' },
