  ...
  pages: {
    ...
    privacy: {
      ...
      body: [
        ...
        { t: "p", v: "Non c'è registrazione, non ci sono cookie di analisi o pubblicitari e non vengono caricate le carte salvate né le impostazioni. L'app e la pagina iniziale non memorizzano nulla di tuo sui nostri server. Teniamo soltanto una statistica d'uso anonima, senza riferimento a persone, vedi sotto." },
