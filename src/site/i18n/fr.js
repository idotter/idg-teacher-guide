  ...
  pages: {
    ...
    privacy: {
      ...
      body: [
        ...
        { t: "p", v: "Il n'y a pas d'inscription, pas de cookies d'analyse ou de publicité et aucun téléversement des favoris ou des réglages. L'application et la page d'accueil n'enregistrent rien de vous sur nos serveurs. Nous tenons seulement une statistique d'utilisation anonyme, sans lien avec des personnes, voir ci-dessous." },
